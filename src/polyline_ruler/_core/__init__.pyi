...
import typing
from . import tf
__all__ = ['CheapRuler', 'LineSegment', 'PolylineRuler', 'douglas_simplify', 'douglas_simplify_indexes', 'douglas_simplify_mask', 'intersect_segments', 'tf']
class CheapRuler:
    class Unit:
        """
        Members:
        ...
        __members__: typing.ClassVar[dict[str, CheapRuler.Unit]]  # value = {'Kilometers': <Unit.Kilometers: 0>, 'Miles': <Unit.Miles: 1>, 'NauticalMiles': <Unit.NauticalMiles: 2>, 'Meters': <Unit.Meters: 3>, 'Metres': <Unit.Meters: 3>, 'Yards': <Unit.Yards: 4>, 'Feet': <Unit.Feet: 5>, 'Inches': <Unit.Inches: 6>}
    ...
    def _fromTile(x: int, y: int) -> CheapRuler:
        ...
    @staticmethod
    def _insideBBox(p: numpy.ndarray[numpy.float64[3, 1]], bbox: tuple[numpy.ndarray[numpy.float64[3, 1]], numpy.ndarray[numpy.float64[3, 1]]], *, cheak_z: bool = False) -> bool:
        ...
    @staticmethod
    def _interpolate(a: numpy.ndarray[numpy.float64[3, 1]], b: numpy.ndarray[numpy.float64[3, 1]], t: float) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    @staticmethod
    def _k(latitude: float, *, unit: CheapRuler.Unit = ...) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    @staticmethod
    ...
    def __init__(self, latitude: float, *, unit: CheapRuler.Unit = ...) -> None:
        ...
    def along(self, line: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.c_contiguous], dist: float) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    def area(self, ring: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.c_contiguous]) -> float:
        ...
    def bearing(self, a: numpy.ndarray[numpy.float64[3, 1]], b: numpy.ndarray[numpy.float64[3, 1]]) -> float:
        ...
    def bufferBBox(self, bbox: tuple[numpy.ndarray[numpy.float64[3, 1]], numpy.ndarray[numpy.float64[3, 1]]], buffer: float) -> tuple[numpy.ndarray[numpy.float64[3, 1]], numpy.ndarray[numpy.float64[3, 1]]]:
        ...
    def bufferPoint(self, p: numpy.ndarray[numpy.float64[3, 1]], buffer: float) -> tuple[numpy.ndarray[numpy.float64[3, 1]], numpy.ndarray[numpy.float64[3, 1]]]:
        ...
    def delta(self, lla0: numpy.ndarray[numpy.float64[3, 1]], lla1: numpy.ndarray[numpy.float64[3, 1]]) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    def destination(self, origin: numpy.ndarray[numpy.float64[3, 1]], dist: float, bearing: float) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    def distance(self, a: numpy.ndarray[numpy.float64[3, 1]], b: numpy.ndarray[numpy.float64[3, 1]]) -> float:
        ...
    def k(self) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    def lineDistance(self, points: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.c_contiguous]) -> float:
        ...
    def lineSlice(self, start: numpy.ndarray[numpy.float64[3, 1]], stop: numpy.ndarray[numpy.float64[3, 1]], line: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.c_contiguous]) -> numpy.ndarray[numpy.float64[m, 3]]:
        ...
    def lineSliceAlong(self, start: float, stop: float, line: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous]) -> numpy.ndarray[numpy.float64[m, 3]]:
        ...
    def offset(self, origin: numpy.ndarray[numpy.float64[3, 1]], dx: float, dy: float, dz: float = 0.0) -> numpy.ndarray[numpy.float64[3, 1]]:
        ...
    def pointOnLine(self, line: numpy.ndarray[numpy.float64[m, 3], numpy.ndarray.flags.c_contiguous], p: numpy.ndarray[numpy.float64[3, 1]]) -> tuple[numpy.ndarray[numpy.float64[3, 1]], int, float]:
        ...
    def pointToSegmentDistance(self, p: numpy.ndarray[numpy.float64[3, 1]], a: numpy.ndarray[numpy.float64[3, 1]], b: numpy.ndarray[numpy.float64[3, 1]]) -> float:
        ...
    def squareDistance(self, a: numpy.ndarray[numpy.float64[3, 1]], b: numpy.ndarray[numpy.float64[3, 1]]) -> float:
        ...
class LineSegment:
